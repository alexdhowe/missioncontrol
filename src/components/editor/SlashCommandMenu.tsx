...
export const SlashCommandMenu = forwardRef(
  ({ items, command }: SlashCommandMenuProps, ref) => {
    ...
    if (items.length === 0) {
      return (
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-3 text-sm text-gray-400">
          No matching blocks
        </div>
      )
    }
    ...
    return (
      <div className="bg-white rounded-lg shadow-lg border border-gray-200 py-1 w-64 max-h-80 overflow-y-auto">
