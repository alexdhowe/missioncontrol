...
export const SlashCommandMenu = forwardRef(
  ({ items, command }: SlashCommandMenuProps, ref) => {
    ...
    if (items.length === 0) {
      return (
        <div className="bg-surface-overlay rounded-lg shadow-glow-lg border border-white/[0.08] p-3 text-sm text-gray-500">
          No matching blocks
        </div>
      )
    }
    ...
    return (
      <div className="bg-surface-overlay rounded-lg shadow-glow-lg border border-white/[0.08] py-1 w-64 max-h-80 overflow-y-auto">
